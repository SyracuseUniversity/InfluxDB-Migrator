...
export interface VerificationResult {
  ...
  checks: {
    ...
    timeRange: {
      passed: boolean;
      source: { earliest: string; latest: string };
      destination: { earliest: string; latest: string };
      message: string;
    };
  };
  warnings: string[];
...
export class Verifier {
  ...
  private async verifyRecordCount(result: VerificationResult): Promise<void> {
  ...
  private async verifyTimeRange(result: VerificationResult): Promise<void> {
